...
const char apiRequest[] = "http://api.tisseo.fr/v2/stops_schedules.json?timetableByArea=1&lineId=line:170&stopPointId=stop_point:SP_1423&number=3&key=4400d02f-d4d6-466a-ba96-8ab78012cf9f";
const char ssid[] = "Bbox-A2AD1E21";
const char password[] = "rmyb4mYX62eyzRbHFK";
